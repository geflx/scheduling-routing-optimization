...
\begin{figure}[ht]
    ...
    \includegraphics[width=1\textwidth]{Images/calibration/general rpd calib ilrs-rvnd-1 int} 
     \caption[]{Calibração de parâmetros para a ILS$\_$RVND$\_$1.}
  	\label{fig:solutionrep}
\end{figure}
...
\begin{figure}[ht]
    ...
    \includegraphics[width=1\textwidth]{Images/calibration/general rpd calib ilrs-rvnd-2 int} 
     \caption[]{Calibração de parâmetros para a ILS$\_$RVND$\_$2.}
  	\label{fig:solutionrep}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption[]{Calibração de parâmetros para o Algoritmo Genético (GA$\_$LS).}
  	\label{fig:solutionrep}
\end{figure}

...
Dessa forma, foram geradas 24 combinações de parâmetros, e cada uma delas foi executada 10 vezes nas 1740 instâncias. O cálculo do Average RPD das execuções possibilitou a escolha da combinação $\{10,100,5\}$ na Figura \ref{fig:calib1}.
...
De forma análoga, o segundo algoritmo ILS$\_$RVND$\_$2, utilizou os intervalos acima e foi executado 10 vezes em cada uma das instâncias.

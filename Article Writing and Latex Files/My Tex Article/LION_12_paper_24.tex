...
\title{AHeurísticas para Agendamento de Produção de uma Máquina Linear e Roteamento de Entrega com Frota Heterogênea de Veículos}
\author{Gabriel de Paula Félix  \and José E. C. Arroyo }
...
\keywords{Single machine scheduling, family setup-times, resource constraints, total tardiness, meta-heuristics.}
\end{abstract}

...
int main(){
    ...
    for(contArquivo=1; contArquivo<=5; contArquivo++){
        ...
        string sheetObjFunction = to_string(contArquivo) +"_FINAL_GA_OBJ_F_" +fileName;
        ofstream sheetObjFunctionFile( sheetObjFunction );

        string detailedResult = to_string(contArquivo) +"_FINAL_GA_DETAILS_" +fileName;
        ofstream detailedResultFile( detailedResult );

        string timeResult = to_string(contArquivo) +"_FINAL_GA_TIME_" +fileName;

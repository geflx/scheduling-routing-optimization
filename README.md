...
## Instances
This different approach required new instances and they were generated based in articles described in .pdf attached. (continue)

## Metaheuristics
In this application were applied different metaheuristics, starting with Iterated Local Search (ILS)- RVND and then extending to Genetic Algorithms, ... (continue)
